...
const helpScreenSource = main.slice(main.indexOf("function HelpScreen"), main.indexOf("function ReviewScreen"));
...
assert.match(tablesScreenSource, /table\.status === "needs-help"/);
assert.match(tablesScreenSource, /Help remark/);
assert.match(tablesScreenSource, /value=\{table\.note\}/);
assert.match(tablesScreenSource, /placeholder="String tip too soft"/);
assert.match(tablesScreenSource, /draftTable\.note = event\.target\.value/);
...
assert.match(helpScreenSource, /Help queue/);
assert.match(helpScreenSource, /No help requests right now/);
assert.doesNotMatch(helpScreenSource, /Quiet requests and fast-finisher prompts/);
assert.doesNotMatch(helpScreenSource, /Fast finishers/);
assert.doesNotMatch(helpScreenSource, /state\.activity\.fastTasks/);
...
assert.match(css, /\.help-remark\s*\{/);
assert.match(css, /\.help-remark input\s*\{/);
